...
public class ORMGenerator
{
    ...
    protected virtual async Task GenerateDbContextAsync(List<ORMGenaratedModel> models)
    {
        ...
        var filePath = Path.Combine(Config.DbContextFolderPath, $"{Config.DbContextName}.cs");
        await File.WriteAllTextAsync(filePath, WrapContentWithNamespaceAndUsing(lines, usings, Config.DbContextNamespace));
    }
    ...
    protected virtual string WrapContentWithNamespaceAndUsing(List<string> lines, List<string> usings, string @namespace)
    {
        ...
        res.Add($"{{");
        res.AddRange(lines.Select(line => $"{TAB}{line}"));
        res.Add($"}}");
